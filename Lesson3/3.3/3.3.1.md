# Expert Coding using JavaScript - Lesson 3 Activity 3.3.1
### @explicitHints true
...
Next, we want to build the base of the aquarium.    Create a new chat command named base.  Inside the chat command, e first need the agent to turn around. Have the agent turn left 2 times.
