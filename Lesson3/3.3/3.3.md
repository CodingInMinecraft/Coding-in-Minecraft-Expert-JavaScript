# Expert Coding using JavaScript - Lesson 3 Activity 3.3
### @explicitHints true
...
We need to clear a 5 x 5 area which means we need to run this if / else statement 5 times to clear one row.  Copy and paste the code **inside the chat command** to repeat it 5 times. 
