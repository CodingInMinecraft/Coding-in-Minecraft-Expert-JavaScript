...
First, we want the to create an on chat command named plant. Inside the chat command, use the agent set assist code to give the agent 64 sunflowers in slot 1. 
