# Expert Coding using JavaScript - Lesson 12 Activity 12.1
### @explicitHints true
...
## Step 5
Still inside the for loop, have the agent move forward the the length of the pen and then turn left. Then have the agent move forward by the width of the pen and then turn left again. Then close the for loop. Outside of the for loop, have the agent move back by 1. THen close the for loop and the function. 
...
3. You know it is correct when your agent builds a 6 x 8 pen. 
...
3. You know it is correct when your agent builds a 6 x 8 pen. 
4. Then, move the player into the pen and place down 4 hay bales along the edge of the pen. 
5. You will know the code worked when 2 cows are spawned into the pen. 
6. Lastly, place down 3 beehives anywhere in the area (but not in the pen.)
7. You will know your code is correct when bees are spawned in the area. 
