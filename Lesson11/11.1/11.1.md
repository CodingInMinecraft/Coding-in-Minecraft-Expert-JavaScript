...
## Step 5
Still inside the for loop, have the agent move forward the length of the pen and then turn left. Then have the agent move forward by the width of the pen and then turn left again. Then close the for loop. Outside of the for loop do the following:
