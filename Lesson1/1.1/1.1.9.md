# Expert Coding using JavaScript - Lesson 1.1.9
### @explicitHints true
...
2.  Open the chat by pressing the letter T on your keyboard. 
3. Type jump 10.  
4. Your player should jump 10 blocks into the air and return to the ground. 
5. You can try other arguments by trying different numbers after the word jump in the chat. 
6. Return to the tutorial by pressing the C key on your keyboard or tapping the Agent icon on your screen when finished.
