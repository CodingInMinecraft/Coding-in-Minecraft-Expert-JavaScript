...
7. **greater than or equal to (>=)**: The greater than or equal to operator returns true if the left operand is greater than or equal to the right operand.
8. **less than or equal to (<=)**: The less than or equal to operator returns true if the expression on the left of the operand is less than or equal to the value or expression on the right.
